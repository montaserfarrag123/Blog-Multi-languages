<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href="index.html"><i class="icon-speedometer"></i> {{__('words.dashbord')}} <span class="tag tag-info">جدید</span></a>
            </li>
            ...
            <li class="nav-title">
             ...
             <li class="nav-item">
                <a class="nav-link" href="{{ route('dashbord.settings') }}"><i class="icon-docs"></i>{{ trans('words.settings') }}</a>
            </li>
